...
from components.kpi_cards import render_kpi_cards, render_score_card
...
# ── Row 1: Overall score + KPI summary (2 rows × 3 cols) ─────────────
...
with col_kpis:
    render_kpi_cards(scored_df, title="Average KPIs")
